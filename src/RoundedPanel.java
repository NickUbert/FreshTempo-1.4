...
public class RoundedPanel extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7936143347147083922L;
	...
	protected Dimension arcs = new Dimension(curveD, curveD);
	/** Distance between shadow border and opaque panel border */
	protected int shadowGap = (int) (.007 * screenX);
	/** The offset of shadow. */
	protected int shadowOffset = (int) (.0017 * screenX) + 1;
	/** The transparency value of shadow. ( 0 - 255) */
	protected int shadowAlpha = (int) (.0325 * screenX);
